package edu.ucr.cs.mobilechord.transportapi.dhash;
...
{
    public static boolean isBetween(BigInt idBig, BigInt firstBig, BigInt lastBig)
    {
        
        BigInt lowerBound = idBig.powerOfTwo(0);
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + Arrays.hashCode(this.number);
        return hash;
    }
    ...
    {
        return (compareTo(new BigInt(b)) == 0);
    }
