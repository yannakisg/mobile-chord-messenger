...
public class RequestFingers extends ChordMessage {
    private String myIP;
    private Integer myPort;
    
    protected RequestFingers() {
        super(ChordMessage.REQUEST_FINGERS);
    }
    
    public RequestFingers(String myIP, Integer myPort) {
        super(ChordMessage.REQUEST_FINGERS);
        this.myIP = myIP;
        this.myPort = myPort;
    }
    ...
    public byte[] toByteArray() {
        ...
        buffer.put(ChordMessage.REQUEST_FINGERS);
    ...
    public static RequestFingers parseArray(byte[] array) {
        if (array == null || array.length == 0) {
            return null;
        }

        RequestFingers msg = new RequestFingers();
