...
public class Chord {
    ...
    private static final BlockingQueue<ReplyFingers> blockingQueueFingers = new LinkedBlockingQueue<ReplyFingers>();
    private static final BlockingQueue<ReplySuccessor> blockingQueueSuccessor = new LinkedBlockingQueue<ReplySuccessor>();
    private static final BlockingQueue<FingerInfo> blockingQueueFinger = new LinkedBlockingQueue<FingerInfo>();
    ...
    private static void updateFingers(Node self, ReplyFingers fingersSuc, ReplyFingers fingersPred) {
        List<BigInt> fingers = new ArrayList<BigInt>();
        List<Pair<String, Integer>> fingersInfo = new ArrayList<Pair<String, Integer>>();
        
        List<BigInt> fingersSucB = new ArrayList<BigInt>();
        List<BigInt> fingersPredB = new ArrayList<BigInt>();
